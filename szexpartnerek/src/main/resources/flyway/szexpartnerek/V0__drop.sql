...
DROP TRIGGER IF EXISTS upfb_gechk_insert;
DROP TRIGGER IF EXISTS upfb_gechk_update;
DROP TRIGGER IF EXISTS upfb_bechk_insert;
...
DROP TABLE IF EXISTS user_partner_feedback_good;
DROP TABLE IF EXISTS user_partner_feedback_bad;
DROP TABLE IF EXISTS user_partner_feedback_details;

DROP TABLE IF EXISTS tmp_user_like;
