...
public class JsoupUtils {
    private static final Function<Element, String> NULL = Element::text;
    ...
    public int tableToCSV(final CsvListWriter writer) throws IOException {
        return this.tableToCSV(writer, JsoupUtils.NULL);
    }
    ...
    private void tableToRow(final List<String> anyl, final Elements els, final Function<Element, String> t) throws IOException {
